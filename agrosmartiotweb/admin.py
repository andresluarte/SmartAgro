...
from .models import Procesos,Contacto,Trabajador,Jornada,Sector,Huerto,Lote,CustomUser,SensorAire,TemperatureHumidityLocation,DecisionEfectuada,HumidityTemperaturaSoil,SensorSuelo,JornadaPorTrato,Empresario_Proveedor
...
admin.site.register(Empresario_Proveedor)
