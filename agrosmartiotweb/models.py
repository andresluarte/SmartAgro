...
class Notificacion(models.Model):
    ...
    tipo_sensor = models.CharField(max_length=10, choices=[('aire', 'Aire'), ('suelo', 'Suelo')], null=True, blank=True)
    sensor_aire = models.ForeignKey('SensorAire', null=True, blank=True, on_delete=models.SET_NULL)
    sensor_suelo = models.ForeignKey('SensorSuelo', null=True, blank=True, on_delete=models.SET_NULL)
