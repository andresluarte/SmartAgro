# Generated by Django 4.2.3 on 2024-10-28 02:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora_creacion', models.TimeField(default=datetime.time(23, 50, 23, 323688), editable=False)),
                ...
                ('trabajo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='agrosmartiotweb.insumoopciones')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora_creacion', models.TimeField(default=datetime.time(23, 50, 23, 325688), editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_creacion', models.DateField(default=datetime.date.today, editable=False)),
                ('hora_creacion', models.TimeField(default=datetime.time(23, 50, 23, 324687), editable=False)),
                ('fecha', models.DateField()),
                ('estado', models.CharField(choices=[('Por Realizar', 'Por Realizar'), ('En Proceso', 'En Proceso'), ('Terminado', 'Terminado')], default='Por Realizar', max_length=15)),
