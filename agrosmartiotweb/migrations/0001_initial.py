# Generated by Django 4.2.3 on 2024-12-12 07:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora_creacion', models.TimeField(default=datetime.time(4, 56, 38, 804202), editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_creacion', models.DateField(default=datetime.date.today, editable=False)),
                ('hora_creacion', models.TimeField(default=datetime.time(4, 56, 38, 802202), editable=False)),
                ('fecha', models.DateField()),
                ('estado', models.CharField(choices=[('Por Realizar', 'Por Realizar'), ('En Proceso', 'En Proceso'), ('Terminado', 'Terminado')], default='Por Realizar', max_length=15)),
